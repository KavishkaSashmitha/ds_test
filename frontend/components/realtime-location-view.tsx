      ...
      try {
        ...
        if (locationData.location) {
          ...
          lastUpdateTimeRef.current = new Date(
            locationData.location.lastUpdate || Date.now()
          );
        ...
        if (locationData.delivery) {
          setDestination({
            ...
            address:
              locationData.delivery.customerAddress || "Delivery location",
          });
        ...
        <CardContent className="py-4">
          <div className="flex flex-col gap-4">
            <div className="flex gap-3 items-start">
              <div className="w-6 h-6 rounded-full bg-blue-500 text-white flex items-center justify-center text-xs mt-1">
                A
              </div>
              <div>
                <p className="font-medium">Pickup</p>
                <p className="text-sm text-gray-500">
                  {origin?.address || "Restaurant"}
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3 items-start">
              <div className="w-6 h-6 rounded-full bg-orange-500 text-white flex items-center justify-center text-xs mt-1">
                B
              </div>
              <div>
                <p className="font-medium">Delivery</p>
                <p className="text-sm text-gray-500">
                  {destination?.address || "Your location"}
                </p>
              </div>
            </div>
          </div>
