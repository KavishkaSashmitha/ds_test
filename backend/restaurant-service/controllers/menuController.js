...
exports.createMenuItem = async (req, res) => {
  try {
    const { restaurantId, image, ...menuItemData } = req.body;

    console.log("Received Image Data:", image); // Debugging log

    // Save the menu item with the base64 image
    const menuItem = new MenuItem({
      ...menuItemData,
      restaurantId,
      image, // Save the base64 image directly
    });
